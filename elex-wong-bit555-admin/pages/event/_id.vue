        ...
        methods: {
            init() {
                if(this.id > 0) {
                    ...
                    this.$api.requestByPost('Event/getDetail', {id: this.id}).then(result => {
            ...
            create() {
                ...
                this.isLoading = true;
                this.$api.requestByPost('Event/create', form).then(result => {
                    if(result.status == true) {
            ...
            update() {
                ...
                this.isLoading = true;
                this.$api.requestByPost('Event/update', form).then(result => {
                    if(result.status == true) {
                        this.$notiflix.Notify.success(result.msg ? result.msg : this.$t('message.success'), {
                            showOnlyTheLastOne: true,
                        });
