        ...
        methods: {
            init() {
                if(this.id > 0) {
                    ...
                    this.$api.requestByPost('Home/getDetail', {id: this.id}).then(result => {
            ...
            create() {
                ...
                this.isLoading = true;
                this.$api.requestByPost('Home/create', form).then(result => {
                    if(result.status == true) {
            ...
            update() {
                ...
                this.isLoading = true;
                this.$api.requestByPost('Home/update', form).then(result => {
                    if(result.status == true) {
                        this.$notiflix.Notify.success(result.msg ? result.msg : this.$t('message.success'), {
                            showOnlyTheLastOne: true,
                        });
...
<style lang="scss" type="text/css">
    @import "/assets/scss/pc/homeDetail.scss";
    @import "/assets/scss/mobile/homeDetail.scss";
</style>
