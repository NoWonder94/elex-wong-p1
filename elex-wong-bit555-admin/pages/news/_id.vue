        ...
        methods: {
            init() {
                if(this.id > 0) {
                    ...
                    this.$api.requestByPost('News/getDetail', {id: this.id}).then(result => {
            ...
            create() {
                ...
                this.isLoading = true;
                this.$api.requestByPost('News/create', form).then(result => {
                    if(result.status == true) {
            ...
            update() {
                ...
                this.isLoading = true;
                this.$api.requestByPost('News/update', form).then(result => {
                    if(result.status == true) {
                        this.$notiflix.Notify.success(result.msg ? result.msg : this.$t('message.success'), {
                            showOnlyTheLastOne: true,
                        });
...
<style lang="scss" type="text/css">
    @import "/assets/scss/pc/newsDetail.scss";
    @import "/assets/scss/mobile/newsDetail.scss";
</style>
