...
use App\Application\Admin\Services\Crypto\HomeService;
...
class HomeController extends AuthController {
	...
	public function create() {
		$rules 				= [
            ...
            'is_top'        => 'required|integer|between:0,2'
    	];
    	$this->validate($rules);

		$result = HomeService::instance()->create(
			Request::post('img'),
			Request::post('title'),
	...
	public function update() {
		...
		$result = HomeService::instance()->update(
			Request::post('id'),
			Request::post('img'),
			Request::post('title'),
			Request::post('description'),
	...
	public function delete() {
		...
		$result = HomeService::instance()->delete(
			Request::post('id')
		);
