...
use App\Application\Admin\Services\Crypto\VideosService;
...
class VideosController extends AuthController {
	public function getList() {
		...
		$result = VideosService::instance()->getList(
			Request::post('title'),
			Request::post('status'),
	...
	public function getDetail() {
		...
		$result = VideosService::instance()->getDetail(
			Request::post('id')
		);
	...
	public function create() {
		...
		$result = VideosService::instance()->create(
			Request::post('img'),
			Request::post('title'),
	...
	public function update() {
		...
		$result = VideosService::instance()->update(
			Request::post('id'),
			Request::post('img'),
			Request::post('title'),
			Request::post('description'),
	...
	public function delete() {
		...
		$result = VideosService::instance()->delete(
			Request::post('id')
		);
