  ...
  data() {
    return {
      headers: [
        { label: "crypto", nav: "/" },
        { label: "news", nav: "/news" },
        //{ label: "exclusives", nav: "/exclusives" },
        //{ label: "videos", nav: "/videos" },
        { label: "guides", nav: "/guides" },
        { label: "exchanges", nav: "/exchanges" },
        //{ label: "market_cap", nav: "/marketCap" },
        { label: "price_tracker", nav: "/priceTracker" },
        //{ label: "podcast", nav: "/podcast" },
      ],
      platforms: [
        {
          label: "Github",
