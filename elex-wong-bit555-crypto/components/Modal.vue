  ...
  <div class="modal" v-if="open">
    <div class="modal-container" v-click-outside="close">
      ...
      <div class="modal-sign-container" v-if="curPage == 'signup'">
        ...
        >
          ...
          <el-form-item>
            <el-button
              ...
              :loading="isLoading"
              >{{ $t("modal.signup") }}</el-button
            >
          </el-form-item>
        </el-form>
        <!-- <div class="modal-input-box">
          <div class="modal-box-label">{{ $t("modal.name") }}</div>
          <el-input placeholder="Jamie Larson" v-model="username"></el-input>
        </div>
        <div class="modal-input-box">
          <div class="modal-box-label">{{ $t("modal.pwd") }}</div>
          <el-input
        ...
        <div class="modal-input-box">
          <div class="modal-box-label">{{ $t("modal.confirmpwd") }}</div>
          <el-input
            placeholder="Please enter your password"
            v-model="pwd"
            show-password
        ...
        <div class="modal-btn">
          <el-button @click="changePage('plan')" :loading="isLoading">
            {{ $t("modal.signup") }}
          </el-button>
        </div> -->
