...
export default {
  ...
  head() {
    return {
      title: this.title ? this.title : this.$i18n.t("types.exchanges"),
    };
  },
  data() {
    return {
  ...
  methods: {
    initialize() {
      ...
      this.$api
        .requestByPost("Exchanges/getList", {
...
// @import "/assets/scss/pc/exchanges.scss";
// @import "/assets/scss/mobile/exchanges.scss";
</style>
