...
export default {
  ...
  head() {
    return {
      title: this.title ? this.title : this.$i18n.t("types.exclusives"),
    };
  },
  data() {
    return {
  ...
  methods: {
    initialize() {
      ...
      this.$api
        .requestByPost("Exclusives/getList", {
...
// @import "/assets/scss/pc/exclusives.scss";
// @import "/assets/scss/mobile/exclusives.scss";
</style>
