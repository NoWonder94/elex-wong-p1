...
export default {
  ...
  head() {
    return {
      title: this.title ? this.title : this.$i18n.t("types.market_cap"),
    };
  },
  data() {
    return {
  ...
  methods: {
    initialize() {
      ...
      this.$api
        .requestByPost("MarketCap/getList", {
...
// @import "/assets/scss/pc/marketCap.scss";
// @import "/assets/scss/mobile/marketCap.scss";
</style>
