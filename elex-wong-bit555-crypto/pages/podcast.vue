...
export default {
  ...
  head() {
    return {
      title: this.title ? this.title : this.$i18n.t("types.podcast"),
    };
  },
  data() {
    return {
...
// @import "/assets/scss/pc/podcast.scss";
// @import "/assets/scss/mobile/podcast.scss";
</style>
