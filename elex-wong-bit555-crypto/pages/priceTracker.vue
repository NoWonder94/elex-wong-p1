...
export default {
  ...
  head() {
    return {
      title: this.title ? this.title : this.$i18n.t("types.price_tracker"),
    };
  },
  data() {
    return {
  ...
  methods: {
    initialize() {
      ...
      this.$api
        .requestByPost("PriceTracker/getList", {
...
// @import "/assets/scss/pc/priceTracker.scss";
// @import "/assets/scss/mobile/priceTracker.scss";
</style>
