...
export default {
  ...
  head() {
    return {
      title: this.title ? this.title : this.$i18n.t("types.videos"),
    };
  },
  data() {
    return {
...
// @import "/assets/scss/pc/videos.scss";
// @import "/assets/scss/mobile/videos.scss";
</style>
