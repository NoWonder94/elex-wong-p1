<?php
namespace App\Http\Controllers\Api\App\Game\Mohjong;

use Illuminate\Http\Request;
use App\Http\Controllers\Api\Controller;
use App\Http\Requests\App\Game\Mohjong\Config\ItemRequest;
use App\Services\App\Game\Mohjong\ConfigService;
