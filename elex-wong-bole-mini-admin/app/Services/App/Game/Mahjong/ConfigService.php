...
use App\Mappers\App\Game\Mahjong\ConfigMapper;
...
class ConfigService
{
    ...
    {
        return GameModel::GAME_ID_MAHJONG;
    }
    ...
    public function update($orgId, $sceneId, $request)
    {
        ...
        // 抛出更新游戏配置事件
        \App\Events\App\Game\Mahjong\ConfigUpdateEvent::dispatch($data['operator_id'], $data['game_id']);
