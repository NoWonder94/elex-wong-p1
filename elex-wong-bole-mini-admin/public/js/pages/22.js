...
var update = __webpack_require__(704)("2322babe", content, false, {});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    data: function data() {
        return {
            ...
            fields: [{ key: 'domain_name', label: '站点域名', sortable: true }, { key: 'company_name', label: '公司名称', sortable: true }, { key: 'customer_name', label: '负责人姓名', sortable: true }, { key: 'customer_email', label: '负责人邮箱', sortable: true }, { key: 'finance_name', label: '财政姓名', sortable: true }, { key: 'finance_email', label: '财政邮箱', sortable: true }, { key: 'actions', label: '操作' }],
            resultData: [],
    ...
    methods: {
        ...
        init: function init() {
            ...
            axios.get('/member/getList').then(function (response) {
                ...
                _this2.currencyList = response.data.resp_data.currencyList;
