...
var update = __webpack_require__(704)("19076719", content, false, {});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    data: function data() {
        return {
            ...
            fields: [{ key: 'name', label: '账户' }, { key: 'admin_type', label: '管理员组' }, { key: 'date_create', label: '创建时间' }, { key: 'date_login', label: '登入时间' }, { key: 'ip_login', label: '登入IP' }, { key: 'count_login', label: '登入次数' }, { key: 'status', label: '状态' }, { key: 'actions', label: '操作' }],
            resultData: [],
