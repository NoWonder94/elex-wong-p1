    ...
    <div class="page-content pt-2" v-loading="loading">
        ...
        <div class="page-container-inner pt-0">
            <el-table style="width: 100%"
                ...
                <el-table-column min-width="70" :label="$t('game.log.thLable.status')">
                    <template slot-scope="scope">
    ...
    export default {
        ...
        methods: {
            ...
            getSummaries() {
                ...
                sums[7] = this.$options.filters.numeral(this.dataSumTotal.bet_base, '0,0.[0000]');
                sums[8] = this.$options.filters.numeral(this.dataSumTotal.bet_num, '0,0.[0000]');
