<template>
    <el-dialog class="dialog-playback" :title="$t('game.log.replayMahjong.title')" width="690px" :visible.sync="dialogVisible" @close="$emit('update:visible', false)">
        <!-- vbar滚动条 -->
                            ...
                            <el-row v-if="recordData.data.length > 0">
                                <el-col :span="12">
                                    <el-form label-width="80px">
                                        <el-form-item :label="$t('game.log.replayMahjong.gameName')">{{ data.game_name }}</el-form-item>
                                ...
                                <el-col :span="12">
                                    <el-form label-width="80px">
                                        ...
                                        <el-form-item :label="$t('game.log.replayMahjong.seat'+index)" v-for="(item, index) in playersByPlayback" :key="index">
