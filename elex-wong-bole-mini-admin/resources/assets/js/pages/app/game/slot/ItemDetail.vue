<template>
    <el-dialog class="dialog-detail-slot" :title="$t('game.log.detailSlot.title')" width="560px" :visible.sync="dialogVisible" @close="$emit('update:visible', false)">
        <div style="min-height: 300px" v-loading="recordLoading">
            <iframe class="iframe-container" ref="iframeResults"
                    ...
                    style="border: 0 none; width: 100%; height: 293px;">
            </iframe>
    ...
    export default {
        ...
        methods: {
            ...
            getRecordDetails(key, data) {
                ...
                axios.get('/game/record/slot/getRecordDetails', {
                    params: {
