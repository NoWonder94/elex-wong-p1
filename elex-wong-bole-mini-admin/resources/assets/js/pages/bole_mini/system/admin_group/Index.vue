<template>
	<div class="admin-group" v-loading="loading">
		<div class="header-right">
            <div class="header-right-content">
                <div class="button-home">
                    <router-link to="/system/adminGroup">
                ...
                <div class="action">
                    <el-form :inline="true" :model="searchForm">
                        ...
                        <div class="action-list">
                            <div class="button-add" @click="showModal('addForm')" v-if="authority.indexOf(25) >= 0">
        	...
        	<div class="table-template">
	        	<b-table :items="resultData" :fields="fields" :per-page="amountPerPage" :current-page="currentPage" :filter="filter" @filtered="onFiltered">
	            	...
	            	<template slot-scope="row" slot="actions">
	                    <b-button class="edit" @click.stop="showModal('updateForm', row.item)" v-if="authority.indexOf(26) >= 0">
	                        {{ $t('button.edit') }}
	                    </b-button>
	                    <b-button class="delete" @click.stop="showModal('deleteForm', row.item)" v-if="authority.indexOf(27) >= 0">
	                        {{ $t('button.delete') }}
	                    </b-button>
	            	</template>
        ...
        <item-detail :visible.sync="isDialogVisible" :formType="formType" :detail="detail" :menuList="menuList">
        </item-detail>
	</div>
</template>
<script>
	...
	export default {
		...
		methods: {
			...
			init() {
                axios.get('/system/adminGroup/getList').then((response) => {
...
<style lang="scss" type="text/css">
	@import "../../../../../scss/bole_mini/AdminGroup.scss";
</style>