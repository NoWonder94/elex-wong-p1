<template>
    <div class="page-content" v-loading="loading">
        ...
        <el-table style="width: 100%"
                  ...
                  show-summary>
            <el-table-column min-width="150" :label="$t('game.player-bet.thLable.hour')" prop="id" sortable="custom" :sort-orders="['ascending', 'descending']">
                <template slot-scope="scope">
                    <component-page-timestamp :timestamp="scope.row.timed" type="hour"></component-page-timestamp>
                </template>
            </el-table-column>
