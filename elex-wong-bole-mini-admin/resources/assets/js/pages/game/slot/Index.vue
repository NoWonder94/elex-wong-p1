                                    ...
                                    <el-row :gutter="20" v-else>
                                        <el-col :lg="24">
                                            <el-card shadow="never" class="grid-content">
                                                ...
                                                <span class="grid-content-item">{{ $t('form.slotScenes[0].label') }}：{{ gameStatus.amount_playing[1001] | numeral('0,0.[0000]') }}</span>
                                                <span class="grid-content-item">{{ $t('form.slotScenes[1].label') }}：{{ gameStatus.amount_playing[1002] | numeral('0,0.[0000]') }}</span>
                                                <span class="grid-content-item">{{ $t('form.slotScenes[2].label') }}：{{ gameStatus.amount_playing[1003] | numeral('0,0.[0000]') }}</span>
                                                <span class="grid-content-item">{{ $t('form.slotScenes[3].label') }}：{{ gameStatus.amount_playing[1004] | numeral('0,0.[0000]') }}</span>
                                                <span class="grid-content-item">{{ $t('form.slotScenes[4].label') }}：{{ gameStatus.amount_playing[1005] | numeral('0,0.[0000]') }}</span>
                                            </el-card>
                                        </el-col>
                                    </el-row>
                                </div>
    ...
    export default {
        ...
        methods: {
            getGameStatus() {
                ...
                axios.get('/app/game/slot/index/getGameStatus').then((response) => {
