...
<head>
  ...
  <!-- datepicker -->
  <link rel="stylesheet" href="{{ Helper::resource('static/vendor/bootstrap-datepicker/bootstrap-datepicker.min.css') }}?{{ $tpl_version }}">
...
<body class="dashboard">
      ...
      <div class="collapse navbar-collapse navbar-collapse-toolbar" id="site-navbar-collapse">
        ...
        <ul class="nav navbar-toolbar">
          ...
          <li class="hidden-float">
            <ol class="breadcrumb">
          <li><a href="#"><i class="icon wb-home"></i>{{ $navs_top['navs_first'] }}</a></li>
          <li class="active">{{ $navs_top['navs_second'] }}</li>
        </ol>
          </li>
        </ul>
        <!-- End Navbar Toolbar -->
        ...
        <ul class="nav navbar-toolbar navbar-right navbar-toolbar-right">
          <li class="dropdown">
            ...
            <ul class="dropdown-menu" role="menu">
              ...
              <li role="presentation">
                <a href="{{ Helper::url('Public/logout') }}" role="menuitem"><i class="icon wb-power" aria-hidden="true"></i> {{ Lang::get('common.logout') }}</a>
              </li>
            </ul>
          </li>
        </ul>
  ...
  <footer class="site-footer">
    <div class="site-footer-legal">© 2017 {{ $site_name }}</div>
  ...
  <!-- datepicker -->
  <script src="{{ Helper::resource('static/vendor/bootstrap-datepicker/bootstrap-datepicker.min.js') }}?{{ $tpl_version }}"></script>
                ...
                if (form.hasClass("ajax-form")) {
                    ...
                    $.ajaxPost(e.target.action, form.serialize(), function(result){
                        if (result.status) {
                          ...
                          if (typeof FANWE.validateResult == 'function') {
                            result_handle = FANWE.validateResult.call(this, form, fv, result.data.field, result.msg);
                          }
