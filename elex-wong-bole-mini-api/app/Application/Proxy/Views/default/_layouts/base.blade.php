        ...
        <ul class="nav navbar-toolbar">
          ...
          <li class="hidden-float">
            <ol class="breadcrumb">
              ...
              @endforeach
              <li class="active">{{ $_now_node['info'][CURRENT_URL] }}</li>
            </ol>
          </li>
        </ul>
        <!-- End Navbar Toolbar -->
        ...
        <ul class="nav navbar-toolbar navbar-right navbar-toolbar-right">
          <li class="dropdown">
            ...
            data-animation="scale-up" role="button" style="line-height:28px;">
              ...
              <span> {{ $login_proxy['name'] }}</span>
            </a>
            <ul class="dropdown-menu" role="menu">
              <li role="presentation">
                <a href="{{ Helper::url('Proxy/edit') }}" role="menuitem"><i class="icon wb-user" aria-hidden="true"></i> 我的信息</a>
              </li>
