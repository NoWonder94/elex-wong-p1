	...
	<div class="login-box">
		<div class="lb-form">
			...
			<div class="input-group input-group-lg">
			  ...
			  <input type="password" name="pwd" class="form-control" placeholder="请输入代理密码">
			</div>
			<div>
...
jQuery(function($){
	$('#loginForm').submit(function(){ 
		if ($.trim(this.name.value) == '') {
			$.showTooltip($(this.name),"请输入代理帐号", null, 'auto top');
			return false;
		}

		if ($.trim(this.pwd.value) == ''){
			$.showTooltip($(this.pwd),"请输入代理密码", null, 'auto top');
			return false;
		}
