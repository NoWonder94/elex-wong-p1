...
@section('body')
    ...
    <tpl:form action="dopwd">
        <tpl:fitem name="old_pwd" type="password" label="原密码" required="true">
             <attrs>
                <attr>data-fv-notempty-message="原密码不能为空"</attr>
            </attrs>
        </tpl:fitem>
        <tpl:fitem name="new_pwd" type="password" label="新密码" required="true">
             <attrs>
                <attr>data-fv-notempty-message="新密码不能为空"</attr>
            </attrs>
        </tpl:fitem>
        <tpl:fitem name="confirm_pwd" type="password" label="确认密码" required="true">
             <attrs>
