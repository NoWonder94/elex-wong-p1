...
<head>
  ...
  <title>{{ Lang::get('common.site_title_' . APP_CURRENT_AGENT_TYPE) }}</title>
  ...
  <nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega" role="navigation">
    <div class="navbar-header">
      ...
      <div class="navbar-brand navbar-brand-center site-gridmenu-toggle" data-toggle="gridmenu">
        ...
        <span class="navbar-brand-text hidden-xs-down"> {{ Lang::get('common.site_name_' . APP_CURRENT_AGENT_TYPE) }}</span>
      </div>
    </div>
    ...
    <div class="navbar-container container-fluid">
      ...
      <div class="collapse navbar-collapse navbar-collapse-toolbar" id="site-navbar-collapse">
        ...
        <ul class="nav navbar-toolbar navbar-right navbar-toolbar-right">
          <li class="nav-item hidden-float">
            <a class="nav-link waves-effect waves-light waves-round" title="{!! Lang::get('admin.show_notice') !!}" href="{{ Helper::url('Notice/index') }}" data-animation="scale-up">
              <i class="icon md-notifications" aria-hidden="true" style="font-size: 20px;"></i>
              <span class="badge badge-pill badge-danger up" id="systemNoticeNum" style="display: none;"></span>
            </a>
          </li>
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" role="menu">
              <a class="dropdown-item" href="{{ Helper::url('Agent/edit') }}" role="menuitem"><i class="icon wb-user" aria-hidden="true"></i> {{Lang::get("admin.update_pwd")}}</a>
...
@if(!$is_ajax_request)
  ...
  <footer class="site-footer">
    <div class="site-footer-legal">© 2019 {{ Lang::get('common.site_name_' . APP_CURRENT_AGENT_TYPE) }}</div>
  ...
  <script>
    (function(document, window, $){
      ...
      $(document).ready(function(){
        ...
        $.ajaxPost("{{ Helper::url('Notice/receive') }}", {}, (result) => {
          if (result.status) {
            if (result.data > 0) {
              $("#systemNoticeNum").html(result.data).show();
            }
          }
        });
