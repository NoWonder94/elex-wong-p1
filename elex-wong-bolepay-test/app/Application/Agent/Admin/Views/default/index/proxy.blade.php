...
<div class="row">
	...
	<div class="col-xl-2 col-lg-4">
		<div class="card card-block p-20">
			<div class="counter counter-md">
				<div class="counter-label text-uppercase">今日旗下订单数</div>
				<div class="counter-number-group">
					@if($statistic['today'])
					<span class="counter-number text-primary">{{ $statistic['today']->order_num }}</span>
					@else
					<span class="counter-number text-primary">0</span>
					@endif
				</div>
	...
	<div class="col-xl-2 col-lg-4">
		<div class="card card-block p-20">
			<div class="counter counter-md">
				<div class="counter-label text-uppercase">今日旗下订单支付总额</div>
				<div class="counter-number-group">
					@if($statistic['today'])
...
<script>
jQuery(function ($) {
	$.ajaxPost("{{ Helper::url('Index/proxychart') }}", [], function (result) {
		c3.generate({
			bindto: '#feeChartBox',
			data: {
