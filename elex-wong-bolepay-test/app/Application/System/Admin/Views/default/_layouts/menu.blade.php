    ...
    <ul class="site-menu-sub">
      ...
      <li class="site-menu-item has-sub{{ $css }}">
        ...
        <ul class="site-menu-sub">
          ...
          @if($_child_node['is_show'] == 1 && Tpl::checkAdminNods($_child_node['controller'], $_child_node['action']))
          <php>
      ...
      @endif
      @elseif($_node['is_show'] == 1 && in_array($_node['id'], $_admin_role['nodes']) && Tpl::checkAdminNods($_node['controller'], $_node['action']))
      <php>
