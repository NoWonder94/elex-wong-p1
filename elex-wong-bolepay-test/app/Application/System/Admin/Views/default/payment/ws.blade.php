...
<div class="form-group input-group">
    <span class="input-group-addon" style="width: 85px;">验签ID</span>
    <input type="text" class="form-control" name="data[cid]" value="{{ $data['data']['cid'] }}">
</div>
<div class="form-group">
    <div class="input-group">
        <span class="input-group-addon" style="width: 120px;">固定金额</span>
