 ...
 * 多语言文本相关配置。
 */
export class pokzjh_activity_task_once_lang_model extends config_model_base {

	public static getClassName(): string {
        return 'pokzjh_activity_task_once_lang_model'
    }

    public static getConfigName(filename?: string): string {
		return `pokzjh_activity_task_once_lang-${filename}.json`;
    }
...
lang_model_map.add(pokzjh_activity_task_once_lang_model);