...
export default class TestPubConfig extends Config {
    /** 发布渠道 */
    public Platform = 'pokzjh';
    /** 包名 */
    public Packagename = 'com.slo.game';
    /** http连接地址 */
...
EnvConfigs.set(Platform.Test, new TestPubConfig());
