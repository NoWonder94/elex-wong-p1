...
import { _decorator, error, Enum, CCString } from 'cc';
const { ccclass, property, menu, help, executeInEditMode } = _decorator;

const LabelArray: string[] = ['cc.Label', 'cc.RichText', 'cc.EditBox'];
...
export default class VMLabel extends VMBase {
    ...
    private labelType: LableType = LableType.Label;
    ...
    setLabelValue(value) {
        let com: any = this.getComponent(LabelArray[this.labelType]);
