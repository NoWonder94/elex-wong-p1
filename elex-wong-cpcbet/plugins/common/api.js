...
// window.axios.defaults.baseURL = 'https://dev.apigolivezhibo.com:10102/dev/api';
// window.axios.defaults.baseURL = 'https://gozlive.com/demo/api';
window.axios.defaults.baseURL = 'https://api.cpcbet.com/cpc/api';
// window.axios.defaults.baseURL = 'https://dev.apigolivezhibo.com:20102/test/api';
