var wallet = {
	...
	<div class="alert alert-success alert-dismissible fade show" role="alert">
			<p><span class="spanalert">The address has been registered successfully.</span></p>
			<p class="text-bold text-wrap">Email3 address: <b style="word-break: break-all;">${that.address}@${that.convertToShortChain(that.chain)}emails.com</b></p>
	...
	<div class="alert alert-success alert-dismissible fade show" role="alert">
			...
			<p><b class="text-bold text-wrap">Email3 address: <b style="word-break: break-all;">${that.address}@${that.convertToShortChain(that.chain)}emails.com</b></b></p>
